...
/**
 * com.jensen.Dashboard 鏄户鎵胯嚜JComonent瀹炵幇鐨勪竴涓华琛ㄧ洏
 *褰撳墠鏀寔绾挎�у埢搴︾洏锛屽姬褰㈠埢搴︾洏锛屽渾褰㈠埢搴︾洏锛屽崐鍦嗗瀷鍒诲害鐩�
 */
public class Dashboard extends JComponent {
    ...
    /**
     * 閲嶅啓paintComponent鏂规硶锛岃幏鍙栨帶浠跺ぇ灏忥紝瀵圭敾甯冭繘琛岄厤缃紝鏍规嵁浼犻�掔被鍨嬶紝杩涜鐩稿簲鍒ゆ柇锛岃皟鐢ㄧ浉搴旂粯鍒舵柟娉�
     * @param g
     */
