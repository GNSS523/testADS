 ...
 */
public class NurientSystemUI extends JFrame{
    private NurientSystem s;
    // PH传感器
    ...
    private void ledUI() {
        ...
        getContentPane().add(ledName);
        getContentPane().add(ledPLC);
        getContentPane().add(ledOn);
        getContentPane().add(ledOff);
        getContentPane().add(ledStatus);
    }
    ...
    private void valveUI() {
        ...
        for(int i = 0;i < 6;i++) {
            ...
            getContentPane().add(valveName.get(finalI));
            getContentPane().add(valvePLC.get(finalI));
            getContentPane().add(valveOn.get(finalI));
            getContentPane().add(valveOff.get(finalI));
            getContentPane().add(valveStstus.get(finalI));
        }
    }
    ...
    private void configUI() {
        ...
        getContentPane().add(configStatus);
    }
    ...
    private void meterUI() {
        ...
        getContentPane().add(meterName);
        getContentPane().add(meterPLC);
        getContentPane().add(meterOn);
        getContentPane().add(meterOff);
        getContentPane().add(meterStatus);
    }
    ...
    private void peUI() {
        ...
        getContentPane().add(pePLC);
        getContentPane().add(peValue);
    }
    ...
    private void ecUI() {
        ...
        getContentPane().add(ecName);
        getContentPane().add(ecPLC);
        getContentPane().add(ecValue);
    }
    ...
    private void phUI() {
        ...
        getContentPane().add(phName);
        getContentPane().add(phPLC);
        getContentPane().add(phValue);
    }

    public static void main(String args[]) {
        NurientSystem s = new NurientSystem(null, 0, "af");
        new NurientSystemUI(s);
    }

    public NurientSystemUI(NurientSystem s) {
        super("Nurient测试");
        this.s = s;
        initGui();
