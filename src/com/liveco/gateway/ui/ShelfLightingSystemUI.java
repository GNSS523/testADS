 ...
 */
public class ShelfLightingSystemUI extends JFrame {
    private ShelfLightingSystem s;
    ...
    public static void main(String[] args) {
        ...
        new ShelfLightingSystemUI(s);
    }

    public ShelfLightingSystemUI(ShelfLightingSystem s) {
        super("ShelfLighting测试");
        this.s = s;
        initGui();
